    ...
    <div className="min-h-[70vh] flex flex-col items-center justify-center p-4">
      ...
      >
        <div className="mb-12 text-center">
          ...
          <h1 className="text-4xl font-black tracking-tighter mb-3 leading-none">Welcome back</h1>
          <p className="text-slate-500 dark:text-slate-400 font-medium tracking-tight">Enter your credentials to continue</p>
        </div>
        ...
        <div className="mt-10 text-center text-sm">
          ...
          <Link to="/signup" className="text-indigo-600 font-black hover:underline underline-offset-4">Create account</Link>
        </div>
      </motion.div>
    </div>
  )
